...
It's a system for parsing mathematical expressions containing IntFloatFrac precision floating point numbers (literals), variables, constants, and functions.
...
> for(i = 0; num = 7^10000, i < 10000, ++i, num/=7)
for(i = 0; num = 7^10000, i < 10000, ++i, num /= 7)
for(i = 0; num = 7^10000, i < 10000, ++i, num /= 7)
        1
