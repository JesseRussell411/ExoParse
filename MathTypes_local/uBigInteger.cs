...
namespace MathTypes
{
    ...
    public struct UBigInteger : IComparable, IComparable<UBigInteger>, IComparable<BigInteger>, IEquatable<UBigInteger>, IEquatable<BigInteger>, IFormattable
    {
        ...
        public int CompareTo([AllowNull] BigInteger other) => Value.CompareTo(other);

        public bool Equals([AllowNull] UBigInteger other) => Value.Equals(other.Value);
        public bool Equals([AllowNull] BigInteger other) => Value.Equals(other);
        #endregion
        ...
        /// <summary>
        /// Finds the greatest common divisor of two MathTypes.uBigInteger values.
        /// </summary>
